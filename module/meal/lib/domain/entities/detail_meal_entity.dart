...
class ListDetailMealEntity extends Equatable {
  final List<DetailMealEntity> meals;

  const ListDetailMealEntity({required this.meals});
  @override
  List<Object?> get props => [meals];
}

class DetailMealEntity extends Equatable {
  final String idMeal;
